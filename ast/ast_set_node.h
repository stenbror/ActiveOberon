...
namespace ActiveOberon::Compiler
{
    ...
    class SetNode : public Node
    {
        ...
        public:
            SetNode(unsigned int start, unsigned int end, Token symbol1, std::shared_ptr<std::vector<std::shared_ptr<Node>>> nodes, std::shared_ptr<std::vector<Token>> commas, Token symbol2) : Node(start, end, NodeFamily::Expression)
            {
