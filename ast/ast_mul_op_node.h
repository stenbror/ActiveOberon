...
namespace ActiveOberon::Compiler
{
    ...
    class MulOpNode : public Node
    {
        ...
        public:
            MulOpNode(unsigned int start, unsigned int end, std::shared_ptr<Node> left, Token symbol, std::shared_ptr<Node> right) : Node(start, end, NodeFamily::Expression)
            {
