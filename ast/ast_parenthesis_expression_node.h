...
namespace ActiveOberon::Compiler
{
    ...
    class ParenthesisExpressionNode : public Node
    {
        private:
            Token m_symbol1;
            Token m_symbol2;
        ...
        public:
            ParenthesisExpressionNode(unsigned int start, unsigned int end, Token symbol1, std::shared_ptr<Node> right, Token symbol2) : Node(start, end, NodeFamily::Expression)
            {
